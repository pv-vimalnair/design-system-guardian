...
final class GuardianWidgetRule extends AnalysisRule {
  GuardianWidgetRule()
      : super(
          name: code.name,
          description: 'Rejects widgets and components without an exact approved constructor mapping.',
        );

  static const LintCode code = LintCode(
    'guardian_unapproved_widget',
    'Widget must resolve to an exact approved design-system component identity.',
    correctionMessage: 'Compose approved primitives or use a Guardian MISSING COMPONENT sentinel.',
  );
