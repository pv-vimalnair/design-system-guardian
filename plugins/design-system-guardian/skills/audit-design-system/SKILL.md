...
Version 0.3.2 does not ship a trusted UX/accessibility evaluator. Request-supplied checks are context, not proof; Guardian canonicalizes this lane to `not_assessed`, exit `4`, and `productionReady=false`. Never convert those assertions into a pass manually.
